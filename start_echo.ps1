...
wt new-tab --title "Ollama" --startingDirectory $dir powershell -NoExit -Command "ollama serve" `; `
  new-tab --title "XTTS Voice" --startingDirectory $dir powershell -NoExit -File "$dir\start_xtts.ps1" `; `
